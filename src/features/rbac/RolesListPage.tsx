...
import { getAvatarColor, getAllRoles } from "@/lib/commonApis";
                  ...
                  >
                    <TableCell component="td" scope="row">
                      <Stack direction="row" spacing={1.5} alignItems="center">
                          <Avatar
                            sx={{ bgcolor: getAvatarColor(row.name), width: 32, height: 32, fontSize: 14 }}
                          >
                          ...
                          <Box>
                            ...
                            <Typography className="m-3" variant="caption" color="text.secondary">{row.slug}</Typography>
                          </Box>
                        </Stack>
